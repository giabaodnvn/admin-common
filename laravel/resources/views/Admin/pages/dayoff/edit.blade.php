                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="name">Nhân viên ID <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="name" name="id" value="{{ old('id', $dayoff->id) }}" placeholder="Nhân viên Id">
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Nhân viên ID <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="name" name="employee_id" value="{{ old('employee_id', $dayoff->employee_id) }}" placeholder="Nhân viên Id">
                                        </div>
                                        <div class="form-group">
