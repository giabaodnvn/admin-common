...
@push('styles')
    <!-- summernote -->
    <link rel="stylesheet" href="static/css/lib/summernote-bs4.css">
    <!-- icheck bootstrap -->
                ...
                <div class="row">
                      <div class="col-md-9">
                        <div class="card card-outline card-info">
                            ...
                            @include('admin.reviews.form', ['review' => null, 'type' => 'create'])
                </div>
            </form>
        </div>
    </section>
...
<script>
    $(function () {
        ...
        $('#lfm-img').filemanager('logo', {prefix: route_prefix});
